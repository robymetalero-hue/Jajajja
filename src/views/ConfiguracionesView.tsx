...
export default function ConfiguracionesView() {
    const { exchangeRate, setExchangeRate, fetchExchangeRate, user, showNotification, receiptTemplate, updateReceiptTemplate, clients, fetchClients, theme, setTheme, rgbSettings, setRgbSettings, pwaPrompt, installPWA, isPwaInstalled } = useAppContext();
